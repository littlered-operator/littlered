...
| G2 | A living, reachable master of **ours** to keep monitoring: `RealMasterIP` set, in `ValidIPs`, and its own Redis view reporting a reachable master. | LR-008's gate reused. Pruning without it manufactures LR-015's leaderless deadlock. |
