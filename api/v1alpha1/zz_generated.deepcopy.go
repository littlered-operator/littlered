...
func (in *ClusterStatusInfo) DeepCopyInto(out *ClusterStatusInfo) {
	*out = *in
	...
	if in.OrphanedReplicas != nil {
		in, out := &in.OrphanedReplicas, &out.OrphanedReplicas
		*out = make([]OrphanedReplicaInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.WipeDeadlockSince != nil {
		in, out := &in.WipeDeadlockSince, &out.WipeDeadlockSince
		*out = (*in).DeepCopy()
	}
	if in.Migration != nil {
...
func (in *FailoverStatus) DeepCopyInto(out *FailoverStatus) {
	*out = *in
	if in.MasterDownSince != nil {
		in, out := &in.MasterDownSince, &out.MasterDownSince
		*out = (*in).DeepCopy()
	}
	if in.TransitionSince != nil {
		in, out := &in.TransitionSince, &out.TransitionSince
		*out = (*in).DeepCopy()
	}
}
...
func (in *LittleRedStatus) DeepCopyInto(out *LittleRedStatus) {
	*out = *in
	if in.LeaderlessSince != nil {
		in, out := &in.LeaderlessSince, &out.LeaderlessSince
		*out = (*in).DeepCopy()
	}
	if in.GhostMasterStuckSince != nil {
	...
	if in.AcknowledgedOperations != nil {
		in, out := &in.AcknowledgedOperations, &out.AcknowledgedOperations
		*out = make([]OperationAck, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OperationAck) DeepCopyInto(out *OperationAck) {
	*out = *in
	in.AcknowledgedAt.DeepCopyInto(&out.AcknowledgedAt)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OperationAck.
func (in *OperationAck) DeepCopy() *OperationAck {
	if in == nil {
		return nil
	}
	out := new(OperationAck)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OrphanedReplicaInfo) DeepCopyInto(out *OrphanedReplicaInfo) {
	*out = *in
	in.DetectedAt.DeepCopyInto(&out.DetectedAt)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OrphanedReplicaInfo.
func (in *OrphanedReplicaInfo) DeepCopy() *OrphanedReplicaInfo {
	if in == nil {
		return nil
	}
	out := new(OrphanedReplicaInfo)
	in.DeepCopyInto(out)
	return out
}
